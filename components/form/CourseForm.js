...
export default function CourseForm({cancelHandler, onSubmit, buttonLabel, defaultValues}) {
  const [inputs, setInputs] = useState({
    ...
    date: {
        value: getFormatted(defaultValues?.date) ?? "",
        isValid: true,
    },
    description: {
  ...
  return (
    <View style={styles.form}>
      ...
      <CustomButton onPress={addOrUpdateHandler} style={styles.addOrUpdate} styleText={styles.addOrUpdateText} label={buttonLabel} />
      </View>
    </View>
  );
}
